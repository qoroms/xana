      ...
      clipImage(img, x, y, size, size, async logodata => {
        try {
          ...
          try {
            ...
            const msg = `Approve Signature on Xana.io with nonce ${nonce}`;
              ...
              try {
                ...
                try {
                  ...
                  signature = await signer.signMessage(
                    `Approve Signature on Xana.io with nonce ${nonce}`
                  );
                } catch (err) {
                  toast(
                    'error',
    ...
    <div className={styles.container}>
      ...
      <div className={styles.inner}>
        ...
        <div style={{ fontSize: '13px' }}>
          ...
          use the owner address, please email us on team@xana.org with the
        ...
        {isRegister && (
          <div className={styles.inputGroup}>
            <div className={styles.inputTitle}>
              Royalty *&nbsp;
              <BootstrapTooltip
                title="Each NFT under this collection exchanged through Xana will have a percentage of sale given to nominated wallet address."
                placement="top"
              >
                <HelpOutlineIcon />
              </BootstrapTooltip>
        ...
        {isRegister && (
          <div className={styles.inputGroup}>
            <div className={styles.inputTitle}>
              Fee Recipient *&nbsp;
              <BootstrapTooltip
                title="The nominated Ethereum Mainnet Network wallet address to receive royalties from each sale in this collection."
                placement="top"
              >
                <HelpOutlineIcon />
              </BootstrapTooltip>
        ...
        <div className={styles.inputGroup}>
          ...
          <div className={styles.inputSubTitle}>
            Adding a category will help make your item discoverable on Xana.
          </div>
          {/* <div className={styles.inputSubTitle}>
        ...
        {!isRegister && (
          <div className={styles.fee}>
            <InfoIcon />
            &nbsp;0.1 ETHs are charged to create a new collection.
          </div>
        )}
      </div>
      {renderMenu}
