...
const PaintBoard = () => {
  ...
  const mintNFT = async () => {
    ...
    if (chainId !== ChainId.MAINNET && chainId !== ChainId.KOVAN) {
      showToast('info', 'You are not connected to Ethereum Mainnet Network');
      return;
    }
    ...
    try {
      ...
      try {
        ...
        let royaltyTx;
        try {
          royaltyTx = await registerRoyalty(
            nft,
            mintedTkId.toNumber(),
        ...
        await axios({
          method: 'post',
          url: `${apiUrl}/nftitems/nftdetails`,
        ...
        <div className={styles.panel}>
          ...
          <div className={styles.fee}>
            {fee !== null ? (
              <>
                <InfoIcon />
                &nbsp;{fee} ETH are charged to create a new NFT.
              </>
            ) : (
