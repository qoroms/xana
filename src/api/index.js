...
export const useApi = () => {
  ...
  const fetchCollections = async () => {
    const res = await axios.post(`${apiUrl}/info/getcollections`);
    return res.data;
  };
  ...
  const itemUpdated = async (
    ...
    const data = {
      args: [owner, nft, id, paymentToken, newPrice],
      blockNumber: 0, //default
      transactionHash: '',
    };
    const res = await axios({
  ...
  const itemCanceled = async (owner, nft, id, authToken) => {
    const data = {
      args: [owner, nft, id],
      blockNumber: 0, //default
      transactionHash: '',
  ...
  const itemSold = async (
    ...
    const data = {
      args: [seller, buyer, nft, id, _quantity, paymentToken, unitPrice, price],
      blockNumber: 0, //default
      transactionHash: '',
    };
    const res = await axios({
  ...
  const offerCreated = async (
    ...
    const data = {
      args: [creator, nft, id, quantity, payToken, pricePerItem, deadline],
      blockNumber: 0, //default
      transactionHash: '',
    };
    const res = await axios({
  ...
  const offerCanceled = async (creator, nft, id, authToken) => {
    const data = {
      args: [creator, nft, id],
      blockNumber: 0, //default
      transactionHash: '',
