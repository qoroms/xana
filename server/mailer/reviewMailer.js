...
const createDenyMessage = (data) => {
  return {
    ...
    text: "xana notification",
    html: `Your collection has been denied to register on Xana. <br/><br/> reason : ${data.reason} </br></br> Thank You.  <br/><br/>`,
  };
};
...
const createApproveMessage = (data) => {
  return {
    ...
    subject: data.subject,
    text: "xana notification",
    html: "Dear Xana User! <br/> Your collection has been successfully registered in Xana. ",
  };
};
