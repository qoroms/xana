    ...
    personalizations: [
      {
        ...
        dynamic_template_data: {
          ...
          name: data.name,
          link: data.link,
          discord: XanaContacts.discord,
          twitter: XanaContacts.twitter,
          telegram: XanaContacts.telegram,
          reddit: XanaContacts.reddit,
          xanaUnsubscribe: XanaContacts.xanaUnsubscribe,
        },
      },
    ],
  };
