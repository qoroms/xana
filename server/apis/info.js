...
router.post('/getCollections', async (_, res) => {
...
router.post('/getOwnership/:address/:tokenID', async (req, res) => {
  try {
...
router.post('/get1155info/:address/:tokenID', async (req, res) => {
  try {
    let collection = toLowerCase(req.params.address);
    let tokenID = parseInt(req.params.tokenID);
    let holdings = await ERC1155HOLDING.find({
...
router.post('/getAccountActivity/:address', async (req, res) => {
...
router.post('/getOffersFromAccount/:address', async (req, res) => {
  try {
    let address = toLowerCase(req.params.address);
...
router.post('/getActivityFromOthers/:address', async (req, res) => {
  try {
    let address = toLowerCase(req.params.address);
...
router.post('/getFigures/:address', async (req, res) => {
  try {
    let address = toLowerCase(req.params.address);
