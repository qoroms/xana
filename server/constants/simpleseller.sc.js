const SimpleNFTSellerContract = {
  MAINNET_ADDRESS: '0x0042a5b0f7148323E909bf5954dfCe90A44B056A',
  TESTNET_ADDRESS: '0xF5688bF118CEcA6865F2f69d4036bA4754aDB65C',
  ABI: [
    {
      anonymous: false,
      inputs: [
    ...
    },
    {
      ...
      outputs: [
        {
          internalType: 'contract IXanaAddressRegistry',
          name: '',
          type: 'address'
        }
      ],
